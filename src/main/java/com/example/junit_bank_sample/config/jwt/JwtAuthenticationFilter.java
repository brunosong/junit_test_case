...
import com.example.junit_bank_sample.dto.user.UserReqDto.*;
import com.example.junit_bank_sample.dto.user.UserRespDto.*;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 강제 로그인
            UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(  //인증관련 토큰
